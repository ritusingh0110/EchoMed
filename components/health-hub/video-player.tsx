...
export function VideoPlayer({ video, isOpen, onClose, onNext, onPrevious, relatedVideos = [] }: VideoPlayerProps) {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // restore previous handler (or noop)
                ...
                {showControls && (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Button variant="ghost" size="icon" className="text-white hover:bg-black/30" onClick={onClose}>
                        <X className="h-5 w-5" />
                      </Button>
                    </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            className={cn("text-white hover:bg-black/30", subtitlesEnabled && "text-primary")}
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-2 text-sm text-muted-foreground">
                            ...
                            <span>
                              {video.viewCount
                                ? `${Number.parseInt(video.viewCount).toLocaleString()} views`
                                : "N/A views"}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between border-y py-3">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className={cn("flex items-center gap-1", isBookmarked && "text-primary")}
