...
const API_KEY = process.env.NEXT_PUBLIC_GOOGLE_GEMINI_API_KEY || process.env.NEXT_PUBLIC_GEMINI_API_KEY || ""

if (!API_KEY) {
  console.warn("[DrEcho] No Gemini API key found in directGemini. Using offline fallback.")
}
